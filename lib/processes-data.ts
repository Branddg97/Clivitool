  ...
  supplies: [
    {
      ...
      description: "Proceso para validar y dar seguimiento al envío del medicamento, ya sea de primera vez o subsecuente.",
      category: "supplies",
      steps: 3,
      avgTime: "10-15 min",
      difficulty: "Medio",
  ...
  citas: [
    {
      ...
      title: "Agendamiento de Citas",
      description: "Proceso para agendar citas según tipo, plan y complejidad del paciente.",
      category: "citas",
      steps: 3,
      avgTime: "10-20 min",
      difficulty: "Medio",
...
// FORCE UPDATE - Tue Mar 17 23:56:37 CST 2026
